...
expression returns [Expression expressionRet] :
    ...
    | exp1=expression{ BinaryOperator op = BinaryOperator.PLUS; Integer line;} (MULT {op = BinaryOperator.MULT; line = $MULT.line;}| DIV{op = BinaryOperator.DIV; line = $DIV.line;} | MOD{op = BinaryOperator.MOD; line = $MOD.line;}) exp2=expression {BinaryExpression binaryexpr = new BinaryExpression($exp1.expressionRet,$exp2.expressionRet,op);binaryexpr.setLine(line);$expressionRet = binaryexpr;}
